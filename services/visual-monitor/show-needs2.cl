  ...
  }
  {
    ...
    */
    ...
    let r_collected = (read @runner_info | fix_time @state asap=true | m-eval asap=true {: runner_info state=@state |
      ...
      let prev = state.history[ runner_info.msg.runner_id ] || {}
