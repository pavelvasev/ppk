...
import * as ABILITIES from "./abils-2.js"
import * as GR4 from "ppk/gr4.js"
...
function main( rapi, worker_ids ) {
  ...
  // публикуем информацию о доступной визуализации
  ABILITIES.setup_visuals( rapi, worker_ids, c1.output )
