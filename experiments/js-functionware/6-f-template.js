...
function main( rapi, worker_ids ) {
  ...
  */
  ...
  function f_1d_borders( ctx, fn )
  {
    if (!fn.operation_id) {
      fn.operation_id = get_new_id(ctx,`op`)
  ...
  let res1 = f_1d_borders( ctx, F.f_part )( p_data )
  let res2 = f_1d_borders( ctx, F.f_part )( res1 )

  let res = f_1d( ctx, F.f_part_div) ( res2 )
