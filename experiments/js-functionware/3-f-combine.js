...
function main( rapi, worker_ids ) {
  ...
  */
  ...
  let res1 = generate_graph_1( {ctx, data:p_data} )
  let res = generate_graph_1( res1 )

  // закольцовываем граф для итераций..
  res.data.forEach( (output_cell, index) => {
