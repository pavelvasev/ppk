...
// при получении запроса в поток control_port
// разово высылает информацию в vis_port
// можно было и на query сделать, но вроде как без разницы

// при этом выгружает данные (делает локальную копию)
