...
# idea сделать команду "начать чтение в ячейку", т.е. на замену reading_cell

# idea нужен какой-то синхронизирующий процесс - эмулятор общей памяти эдакий (переменной сиречь)
